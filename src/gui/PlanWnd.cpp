...
// distance from a1 to a2 counterclockwise ï¿½ [0, 360)
...
void CPlanWnd::Grid()
{
	...
	for (int a = 0; a < 360; a += IncreaseDeg)
	{
		...
		if (IncreaseDeg == 1) r2_um = r_um + ((a % 15) == 0 ? 400.0 : 150.0);
		else r2_um = r_um + ((a % 15) == 0 ? 400.0 : 250.0);

		if (IncreaseDeg == 1 && (a % 5) == 0 && (a % 15) != 0)	r2_um = r_um + 250;
