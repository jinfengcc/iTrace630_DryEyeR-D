...
public:
  BOOL IsValid()
  {
    return m_LicenseType == LT_SOLO || m_LicenseType == LT_COMBO || m_LicenseType == LT_WORKSTATION || m_LicenseType == LT_HOYA || m_LicenseType == LT_DEMO ||
           m_LicenseType == LT_PRESBIA || m_LicenseType == LT_HOYAVIEWER || m_LicenseType == LT_COMBOVIEWER || m_LicenseType == LT_COMBODICOM; // 530
  }
...
private:
  ...
  BOOL DetermineLicenseTypeImpl(const CString &SoftwareAK);
