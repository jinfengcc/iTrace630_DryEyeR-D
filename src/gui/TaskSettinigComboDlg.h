...
class CTaskSettinigComboDlg : public CDialog
{
public:

	CTaskSettinigComboDlg(CWnd* pParentWnd, CTaskSetting OriTask, int WhichTask);
...
private:
	...
	BOOL     m_Order_Text_Show[32];
	int      m_Order_Int[32];
	int      m_Order_OriInt[32];
	int      m_LastSort;
	...
	CButton  m_Wfnv_Check;//6.2.0 Near vision
	...
	CButton  m_Dysfun_Pt_Check;//531
	CButton  m_AstiSou_Check;//531
	CButton  m_DepthFocus_Check;//531
	CButton  m_ToricAli_Check;//  
	...
	CStatic  m_Wfka_Text;
	CStatic  m_Wfac_Text;
	CStatic  m_Wfnv_Text;//6.2.0 ttt Near vision 
	...
	CStatic  m_DysFun_Pt_Text;//531
	CStatic  m_DepthFocus_Text;
	CStatic  m_ToricAli_Text;//  
	...
	afx_msg void OnWfnvClicked() { OnCheckBoxClick(31); };//6.2.0 ttt Near Vision
	...
	afx_msg void OnDysPtfunClicked() { OnCheckBoxClick(28); };//531
	afx_msg void OnDepthFocusClicked() { OnCheckBoxClick(29); };
	afx_msg void OnTorAliClicked() { OnCheckBoxClick(30); };//
