// manual color image capture controller window for high resolution camera
...
BEGIN_MESSAGE_MAP(CHRImgCptCtrlWnd, CMemWnd)
...
//***************************************************************************************
CHRImgCptCtrlWnd::CHRImgCptCtrlWnd() : CMemWnd()
{
}

//***************************************************************************************

CHRImgCptCtrlWnd::~CHRImgCptCtrlWnd()
{
  // int a = 0;
}
//***************************************************************************************
void CHRImgCptCtrlWnd::CreateThisWnd(RECT &Rect, CWnd *pWnd, int ScreenTop, int CapHeight)
{
  CreateWnd(Rect, pWnd);
  ...
  int sh = 10;
  m_eH   = intRound(real_t(m_h - 130) / 12);

  m_FontSize = intRound(0.7 * m_eH);
  ...
  m_RedSlider.Create(_T(""), _T(""), WS_CHILD | WS_VISIBLE, m_sRect[8], this, IDC_MTF_ANGLE_SLIDER);
  m_GreenSlider.Create(_T(""), _T(""), WS_CHILD | WS_VISIBLE, m_sRect[9], this, IDC_MTF_ANGLE_SLIDER);
  m_BlueSlider.Create(_T(""), _T(""), WS_CHILD | WS_VISIBLE, m_sRect[10], this, IDC_MTF_ANGLE_SLIDER);

  m_WhiteLEDsPowerLevelSlider.m_Pos = 30.0 / 50.0;
  m_BrightnessSlider.m_Pos          = 140.0 / 255.0;
  m_ContrastSlider.m_Pos            = 200.0 / 255.0;
  m_RedSlider.m_Pos                 = 100.0 / 255.0;
  m_GreenSlider.m_Pos               = 100.0 / 255.0;
  m_BlueSlider.m_Pos                = 100.0 / 255.0;
...
void CHRImgCptCtrlWnd::Label0()
{
  ...
  m_MemDC.WriteText(s[4], m_rRect[5], Font, WHITE, 2, BLACK);
...
void CHRImgCptCtrlWnd::Label1()
{
  ...
  m_MemDC.WriteText(s[3], m_rRect[3], Font, WHITE, 2, BLACK);
  m_MemDC.WriteText(s[4], m_rRect[4], Font, WHITE, 2, BLACK);
  m_MemDC.WriteText(s[5], m_rRect[5], Font, WHITE, 2, BLACK);
...
void CHRImgCptCtrlWnd::RepaintMemDC()
{
  // ClearMemDC();
}

//***************************************************************************************
void CHRImgCptCtrlWnd::OnVLightEyeRadioClicked()
{
  if (!m_VeryLightEyeRad.GetCheck()) {
    // m_WhiteLEDsPower = 9;
    // m_Brightness = 65;
...
//***************************************************************************************
void CHRImgCptCtrlWnd::OnLightEyeRadioClicked()
{
  if (!m_LightEyeRad.GetCheck()) {
    /*m_WhiteLEDsPower = 11;
    m_Brightness = 80;
...
//***************************************************************************************
void CHRImgCptCtrlWnd::OnMediumEyeRadioClicked()
{
  if (!m_MediumEyeRad.GetCheck()) {
    /*m_WhiteLEDsPower = 10;
    m_Brightness = 95;
...
//***************************************************************************************
void CHRImgCptCtrlWnd::OnDarkEyeRadioClicked()
{
  if (!m_DarkEyeRad.GetCheck()) {
    /*m_WhiteLEDsPower = 10;
    m_Brightness = 110;
...
//***************************************************************************************
void CHRImgCptCtrlWnd::OnVeryDarkEyeRadioClicked()
{
  if (!m_VeryDarkEyeRad.GetCheck()) {
    /*m_WhiteLEDsPower = 9;
    m_Brightness = 126;
...
LRESULT CHRImgCptCtrlWnd::OnSliderChangedPos(WPARAM wParam, LPARAM lParam)
{
  if (m_VeryLightEyeRad.GetCheck()) {
    m_VeryLightEyeRad.SetCheck(FALSE);
    m_VeryLightEyeRad.Repaint();
  ...
  if (y >= m_sRect[5].top && y <= m_sRect[5].bottom) {
    ...
    m_MemDC.FillSolidRect(m_rRect[5].left, m_rRect[4].top, m_rRect[5].right - m_rRect[5].left, m_rRect[5].bottom - m_rRect[5].top, BLACK);
...
//***************************************************************************************
void CHRImgCptCtrlWnd::ShowAcqBtnGUI()
{
  m_ShowAcqBtn = TRUE;
...
void CHRImgCptCtrlWnd::HideAcqBtnGUI()
{
  m_ShowAcqBtn = FALSE;
...
//***************************************************************************************
void CHRImgCptCtrlWnd::OnCaptureBtnClicked()
{
  m_Acquire = TRUE;
}