#if !defined(EXCEL9_FA85E75E7CEB__INCLUDED_)
#define EXCEL9_FA85E75E7CEB__INCLUDED_
...
public:
	...
	long GetTransparentBackgintRound();
	void SetTransparentBackgintRound(long nNewValue);
};
/////////////////////////////////////////////////////////////////////////////
...
public:
	...
	long GetCreator();
	LPDISPATCH GetParent();
	VARIANT GetBackgintRound();
	void SetBackgintRound(const VARIANT& newValue);
	VARIANT GetBold();
...
public:
	...
	double intRound(double Arg1, double Arg2);
...
public:
	...
	VARIANT AutoOutline();
	VARIANT BorderAintRound(const VARIANT& LineStyle, long Weight, long ColorIndex, const VARIANT& Color);
