...
#define DILASCIA_TRACE_EX(id, fmt, ...) TkTraceWinPrintEx(true, id, fmt, __VA_ARGS__)
#define DILASCIA_TRACE_NOTIME(id, fmt, ...) TkTraceWinPrintEx(false, id, fmt, __VA_ARGS__)
