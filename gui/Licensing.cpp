...
CString CLicensing::LicenseName() const
{
	...
	{
		case LT_PRESBIA: return "P";//Presbia
		case LT_DEMO: return "D";//Demo
		case LT_SOLO: return "S";
		case LT_COMBO: return "C";
		case LT_WORKSTATION: return "W";
		case LT_HOYA: return "H";
		case LT_HOYAVIEWER: return "HSV";// HOYA Workstataion Viewer
		case LT_COMBOVIEWER: return "COMBOV";// COMBO Viewer
		case LT_COMBODICOM: return "CD";// COMBO DICOM
	}
...
BOOL CLicensing::DetermineLicenseType(const CString& SoftwareAK)
{
	...
	if (m_HardwareID.IsEmpty()) return FALSE;
...
BOOL CLicensing::GenerateSoftwareAK(const int LicenseType, CString& SoftwareAK)
{
	...
	const int q[9][120] =
	{
		...
		//  COMBO
		{
			29,  21,  34,  34, 113,  59,  14,  66,   7,  93,
			92,  70,  93,  74,  55,  85,  17,  19, 107,  86,
		64,  56,  28,  89,   6,  21,  53,   4,  14,  84,
		77,  57,  94,  27,  56,  28,  62, 114,  42,  39,
		18,  55,  10,  38, 113,  86,  54,  99,  42,   4,
		15,  19,  10,  38,  93, 100,  87,  99,  42,   4,
		29, 110,  39,  47, 111,  58, 107, 119,  67,  68,
		97,  43,  34,   7,  33,  71,  35,  62,  15,   5,
		27,  26,  48,  61, 101,  20,   2,  57, 115,  81,
		15,  59,  73,  22,  69,   3,  95,  118, 49,  90,
		29,  17,  76,   8,  18,  73,  25,  69,  52,  52,
		31, 105,  63,  89, 101,  19,  25,  84,  38,  77
		},
		// WORKSTATION
		{
			31,  32,   8,  61,  16,  89, 109,  36,   0,  63,
			64, 108,  23,  74,  60, 103, 104,  85, 112,  55,
		13,  45,   3,  98, 101,  91, 105,  88,  83,  97,
		29, 110,  39,  47, 111,  58, 107, 119,  67,  68,
		79,  34,  43,  70,  44,  17,  53,  26,  51,  50,
		46,  65,  82,   9, 106,  12,  35,  40,  41,  48,
		77,  57,  94,  27,  56,  28,  62,  14,  24,  30,
		15,  19,  10,  38,  93, 100,  87,  99,  42,   4,
		78,   5,  71,  33, 113,  86,  54, 114,  72,  66,
		7,   6,  84, 116,  21,  11, 102,  75, 115,  81,
		2,  59,  73,  22,  69,  76,  95,  18,  49,  90,
		92, 117,  80, 118,   1,  37,  52,  96,  25,  20
		},
		// HOYA
		{
			102,  88,  20,  37,  40,  69,  44, 112,  33,  64,
			111,  67,  53,  97,  23,  80,  96, 119, 114,  39,
		74,   8, 103,  94,  93, 104,  22,  78,  99, 108,
		16,  51,  18,   0,  30,  47,  61,  60,  95, 113,
		36,  83, 101,  57, 115,  42,   5,  82,  28,  59,
		24,   2,  71,  15,  84,  75,  41,  81,  50,   4,
		56,  14, 107,   7,  91,  27,  52, 100,  65, 116,
		11,  46,  72,  86,  21,  58,  87,  38,   9,  92,
		77,  12,  10, 110,   3,  79,  73,  68,  70,  98,
		1,  55,   6,  76,  19,  26,  48,  66,  32,  85,
		109,  25,  54, 105, 106,  63,  35, 117,  17, 118,
		89,  62,  31,  90,  34,  29,  43,  49,  13,  45,
		},
		// DEMO
		{
			116, 118,  17,  91, 109,  46,  78,  56,  55,  77,
			35,  33,  60,  20,  36,  16,   4,  43,  12,  24,
		54,  38,  94,  65,  68,  29,  64,   8,   5,  76,
		47, 112,  28,  31,   2,  19,  69,  41,  42,  95,
		40,   0, 119, 106,  93,  48,  37,  84,  15,  71,
		47,  96, 111,  89, 104,  10,  22,  80, 102,   1,
		41,  18,  52,  75,  66,  63, 115,  90,  47,  30,
		43,   6, 107,  72,  11, 110,  61,  88,  59,  25,
		43,  14,  74,  32, 105, 100,  40,  82,  97,   7,
		47, 103,  99,  83,  54,   9,  70,  13, 117, 113,
		42,  62,  98,  44, 101, 108,  86,  26,   3,  21,
		15,  53,  58,  57,  79,  39,  85,  34,  49,  81
		},
		// PRESBIA
		{
			113,  44,  95,  32,  99,   4,  70,  33,  86,  45,
			20,  54, 109,  24, 112, 103,  91,  41,  53, 114,
		1,  28,  97,  52,  69, 117, 104,  48,  76,  51,
		85,  96,  25,  50,  57,  98,  84,  10,  74,  36,
		79,  26, 119,   2,  56,  35,  61,  67,  47,  16,
		107,  15,  31,  63,  37, 118,  29, 106,  59,  34,
		101,  71, 115, 108,  88,  30,   6,  13,  58, 110,
		93,  94,  38,  64,   8,  83,  11,  19,  77,  46,
		55,  90,  68, 116,   0,  82,  22,   3,  92,  80,
		49,  78,  65,  21,  60,  72,  43,  27,  89,  18,
		9, 100,  66,  81, 105,  14,   7,  73,   5,  75,
		87,  39,  62,  23,  42,  17,  40,  12, 111, 102
		},
		// HOYA Workstation Viewer
		{
			20,  54, 109,  24, 112, 103,  91,  41,  53, 114,
			113,  44,  95,  32,  99,   4,  70,  33,  86,  45,
		23,  14,  74,  32, 105, 100,  40,  82,  97,   7,
		97,  43,  34,   7,  33,  71,  35,  62,  15,   5,
		50,   0, 119, 106,  93,  48,  37,  84,  15,  71,
		79,  26, 119,   2,  56,  35,  61,  67,  47,  16,
		93,  94,  38,  64,   8,  83,  11,  19,  77,  46,
		101,  71, 115, 108,  88,  30,   6,  13,  58, 110,
		49,  78,  65,  21,  60,  72,  43,  27,  89,  18,
		...
		1,  28,  97,  52,  69, 117, 104,  48,  76,  51,
		107,  15,  31,  63,  37, 118,  29, 106,  59,  34,
		45,  53,  58,  57,  79,  39,  85,  34,  49,  81,
		102,  88,  20,  37,  40,  69,  44, 112,  33,  64,
		74,   8, 103,  94,  93, 104,  22,  78,  99, 108,
		19,  38,  95,  41,  30,  52,  13,  87,  59,  28,
		45,  10,  98,  16,  20, 110,  32,  13,   2,  20,
		113,  44,  95,  32,  99,   4,  70,  33,  86,  45,
		99,   0,   5,   1, 103,  24,  73,  73,  55,  75,
		},
	...
	switch (LicenseType)
	{
	case LT_SOLO: l = 0; break;
	case LT_COMBO: l = 1; break;
	case LT_WORKSTATION: l = 2; break;
	case LT_HOYA: l = 3; break;
	case LT_DEMO: l = 4; break;
	case LT_PRESBIA: l = 5; break;
	case LT_HOYAVIEWER: l = 6; break;
	case LT_COMBOVIEWER: l = 7; break;
	case LT_COMBODICOM: l = 8; break;
	default: return FALSE;
	}

	if (m_HardwareID.GetLength() != 20) return FALSE;
...
BOOL CLicensing::GetSystemBIOSString(CString& S)
{
	...
	if (!Key.GetStrValue("SystemBiosDate", S1)) return FALSE;

	if (!Key.GetStrValue("SystemBiosVersion", S2)) return FALSE;
...
BOOL CLicensing::GetVideoBIOSString(CString& S)
{
	...
	if (!Key.GetStrValue("VideoBiosDate", S1)) return FALSE;

	if (!Key.GetStrValue("VideoBiosVersion", S2)) return FALSE;
...
BOOL CLicensing::GetProcessorString(CString& S)
{
	...
	if (!Key.GetStrValue("ProcessorNameString", S1)) return FALSE;

	if (!Key.GetStrValue("Identifier", S2)) return FALSE;
...
BOOL CLicensing::GetHardwareString1(CString& s)
{
	...
	if (!s1.IsEmpty()) NumGood++;
	if (!s2.IsEmpty()) NumGood++;
	if (!s3.IsEmpty()) NumGood++;
	if (!s4.IsEmpty()) NumGood++;

	if (NumGood < 3) return FALSE;
...
BOOL CLicensing::GetHardwareString2(CString& s)
{
	...
	while (pEnumerator)
	{
		...
		if (pEnumerator->Next(WBEM_INFINITE, 1, &pClassObject, &uReturn) != WBEM_S_NO_ERROR) break;
