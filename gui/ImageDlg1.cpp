...
BEGIN_MESSAGE_MAP(CImageDlg1, CDialog)
...
//***************************************************************************************
int CImageDlg1::m_wheel_n = 0;//520
							  //***************************************************************************************

CImageDlg1::CImageDlg1(CWnd* pParentWnd, CEyeImage* pImage, BOOL WF, BOOL Gray, BOOL RADIAL_RULER) : CDialog(IDD_IMAGE_DLG3, pParentWnd)
{
	m_WF = WF;
	m_Gray = Gray;
...
void CImageDlg1::DoDataExchange(CDataExchange* pDX)
{
...
void CImageDlg1::OnLButtonUp(uint nFlags, CPoint Point)
{
...
//***************************************************************************************
void CImageDlg1::OnLButtonDown(uint nFlags, CPoint Point)
{
	if (Point.x < m_l || Point.x >= m_l + m_w || Point.y < m_t || Point.y >= m_t + m_h) return;
...
void CImageDlg1::OnMouseMove(uint nFlags, CPoint Point)
{
	if (Point.x < m_l || Point.x >= m_l + m_w || Point.y < m_t || Point.y >= m_t + m_h) return;
...
void CImageDlg1::OnPupilRadioClicked()
{
	DisableLimbusRadios();
	DisableVertexRadios();
...
void CImageDlg1::OnPupil1RadioClicked()
{
	if (m_pImage->m_pu_ok) {
...
void CImageDlg1::OnPupil2RadioClicked()
{
	m_Image.ClearPupil();
...
void CImageDlg1::OnPupil3RadioClicked()
{
	CBusyCursor Cursor;
...
void CImageDlg1::OnPupil4RadioClicked()
{
	m_Pupil1Radio.SetCheck(0);
	m_Pupil2Radio.SetCheck(0);
	m_Pupil3Radio.SetCheck(0);
...
void CImageDlg1::OnLimbusRadioClicked()
{
	DisablePupilRadios();
	DisableVertexRadios();
	DisableRadialRulerRadios();//520
...
void CImageDlg1::OnLimbus1RadioClicked()
{
	if (m_pImage->m_li_ok) {
...
void CImageDlg1::OnLimbus2RadioClicked()
{
	m_Image.ClearLimbus();
...
void CImageDlg1::OnLimbus3RadioClicked()
{
	CBusyCursor Cursor;
	...
	else
	{
		...
		//TestImage->SaveIntoFile("C://cTestabc.bmp");
...
void CImageDlg1::OnLimbus4RadioClicked()
{
	m_Limbus1Radio.SetCheck(0);
	m_Limbus2Radio.SetCheck(0);
	m_Limbus3Radio.SetCheck(0);
...
void CImageDlg1::OnVertexRadioClicked()
{
	DisablePupilRadios();
	DisableLimbusRadios();
	DisableRadialRulerRadios();//520
...
void CImageDlg1::OnVertex1RadioClicked()
{
	if (m_pImage->m_ve_ok) {
		m_Image.m_ve_ok = TRUE;
...
void CImageDlg1::OnVertex2RadioClicked()
{
...
void CImageDlg1::OnVertex3RadioClicked()
{
	CBusyCursor Cursor;
...
void CImageDlg1::OnVertex4RadioClicked()
{
	m_V = 4;
	Repaint();
}
...
//520
void CImageDlg1::OnRadialRulerClicked()
{
	DisablePupilRadios();
	DisableLimbusRadios();
	DisableVertexRadios();
...
void CImageDlg1::OnRadialRuler1Clicked()
{
...
void CImageDlg1::OnRadialRuler2Clicked()
{
	m_Image.ClearRuler();
...
void CImageDlg1::OnRadialRuler3Clicked()
{
	m_RadialRuler1Radio.SetCheck(0);
	m_RadialRuler2Radio.SetCheck(0);
...
//520
void CImageDlg1::OnLinearRulerClicked()
{
	DisablePupilRadios();
	DisableLimbusRadios();
	DisableVertexRadios();
...
void CImageDlg1::OnLinearRuler1Clicked()
{
...
void CImageDlg1::OnLinearRuler2Clicked()
{
	m_Image.ClearLRuler();
...
void CImageDlg1::OnLinearRuler3Clicked()
{
	m_LinearRuler1Radio.SetCheck(0);
	m_LinearRuler2Radio.SetCheck(0);
...
void CImageDlg1::OnInlayClicked()
{
	DisablePupilRadios();
	DisableLimbusRadios();
	DisableVertexRadios();
...
void CImageDlg1::OnInlay1Clicked()//Original
{
...
void CImageDlg1::OnInlay2Clicked()//No inlay
{
...
void CImageDlg1::OnInlay3Clicked()//Auto
{
...
void CImageDlg1::OnInlay4Clicked()//Manual
{
	if (!m_Image.m_In_ok)
	{
		if (m_Image.m_ve_ok) //m_pImage are comes from lat save info, m_Image is maped to current info
...
void CImageDlg1::OnSetInalyDBtnClicked()
{
...
BOOL CImageDlg1::IsDigital(CString strItem)
{
...
void CImageDlg1::DrawEye(CMDC& MemDC)
{
...
void CImageDlg1::DrawPupil(CMDC& MemDC)
{
...
void CImageDlg1::DrawLimbus(CMDC& MemDC)
{
...
void CImageDlg1::DrawVertex(CMDC& MemDC)
{
...
void CImageDlg1::DrawRuler(CMDC& MemDC)
{
...
//***************************************************************************************
//520
void CImageDlg1::DrawLRuler(CMDC& MemDC)
{
...
//520
//***************************************************************************************
void CImageDlg1::DrawInlay(CMDC& MemDC)
{
...
void CImageDlg1::DisablePupilRadios()
{
...
void CImageDlg1::DisableLimbusRadios()
{
...
void CImageDlg1::DisableVertexRadios()
{
...
//520
void CImageDlg1::DisableRadialRulerRadios()
{
...
//520
void CImageDlg1::DisableLinearRulerRadios()
{
...
//520
void CImageDlg1::DisableInlayRadios()
{
...
//***************************************************************************************
//520
BOOL CImageDlg1::OnMouseWheel(uint nFlags, short zDelta, CPoint Point)
{
...
BOOL CImageDlg1::PreTranslateMessage(MSG* pMsg)
{
