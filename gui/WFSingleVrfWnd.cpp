...
CWFSingleVrfWnd::CWFSingleVrfWnd(CWnd* pWnd, RECT& WndRect, CPatient* pPatient, CWFExam* pWFExam, CWndSettings* pWndSettings, int whichExam, BOOL ShowExamNum) :
...
void CWFSingleVrfWnd::AddDefocus(real SphEq)
{
	if ((m_pWndSettings + 1)->m_Type == TYPE_TRSD) {
		CRSDWnd* pWnd = (CRSDWnd*)m_pDispWnd[1];
		if (pWnd) {
