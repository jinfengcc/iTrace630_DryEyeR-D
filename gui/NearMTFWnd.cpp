...
BEGIN_MESSAGE_MAP(CNearMTFWnd, CDispWnd)
...
CNearMTFWnd::CNearMTFWnd(RECT& Rect, CWnd* pWnd) : CDispWnd(Rect, pWnd)
{
}

//***************************************************************************************

void CNearMTFWnd::CreateSlider()
{
...
LRESULT CNearMTFWnd::OnSliderChangedPos(WPARAM wParam, LPARAM lParam)
{
...
void CNearMTFWnd::Mtf2D()
{
	...
	// average height
	m_RTLabel[1].Format(_T("Avg Height = %.3f"), avg);
